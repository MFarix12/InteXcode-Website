...
if (projectModal) {
    const projectData = {
        1: {    title: "Flowline Operations Hub", 
                ...
                outcome: "Shorter handoffs, clearer ownership and a more dependable daily operating rhythm.", 
                year: "2025", 
                duration: "8 months", 
                images: ["https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=1400&q=85", "https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=1400&q=85"] 
            },
        2: {    title: "CareConnect Portal", 
                category: "HEALTHCARE / 2024", 
                overview: "A secure digital front door that makes service journeys simpler for customers and support teams.", 
                challenge: "Customers needed a clearer way to find information, submit requests and understand what happened next.", 
                solution: "We created an accessible self-service portal with guided journeys, secure authentication and a support team console.", 
                ...
                outcome: "A calmer customer experience and better visibility for service teams.", 
                year: "2024", 
                duration: "6 months", 
                images: ["https://images.unsplash.com/photo-1559757175-0eb30cd8c063?auto=format&fit=crop&w=1400&q=85", "https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?auto=format&fit=crop&w=1400&q=85"] 
            },
        3: {    title: "Signal Insights", 
                ...
                outcome: "Faster access to useful context and more consistent planning conversations.", 
                year: "2024", 
                duration: "7 months", 
                images: ["https://images.unsplash.com/photo-1556761175-b413da4baf72?auto=format&fit=crop&w=1400&q=85", "https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=1400&q=85"] 
            },
        4: {    title: "Northstar Commerce", 
                category: "COMMERCE / 2023", 
                overview: "A flexible commerce experience designed to make discovery, purchase and fulfilment feel effortless.", 
                challenge: "The existing customer journey was difficult to navigate and could not adapt quickly to new offers.", 
                solution: "We redesigned the experience around customer intent and built a modular platform for faster iteration.", 
                ...
                outcome: "A clearer path to purchase and a stronger foundation for future growth.", 
                year: "2023", 
                duration: "9 months", 
                images: ["https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?auto=format&fit=crop&w=1400&q=85", "https://images.unsplash.com/photo-1556740749-887f6717d7e4?auto=format&fit=crop&w=1400&q=85"] 
            },
        5: {    title: "Fleetwise Control", 
                category: "LOGISTICS / 2023", 
                overview: "A live planning and control view that brings vehicles, teams and delivery priorities together.", 
                challenge: "Planning depended on delayed updates and multiple tools that did not share the same picture.", 
                solution: "We connected operational data into a focused control centre with clear status, ownership and exception handling.", 
                ...
                outcome: "Quicker response to exceptions and a shared view across the operation.", 
                year: "2023", 
                duration: "10 months", 
                images: ["https://images.unsplash.com/photo-1494412651409-8963ce7935a7?auto=format&fit=crop&w=1400&q=85", "https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?auto=format&fit=crop&w=1400&q=85"] 
            },
        6: {    title: "CloudBase Modernisation", 
                category: "CLOUD / 2022", 
                overview: "A safer, more observable cloud foundation for a growing digital service.", 
                challenge: "Legacy infrastructure limited release confidence and made system health difficult to understand.", 
                solution: "We introduced a staged cloud architecture, deployment automation, access controls and meaningful monitoring.", 
                ...
                outcome: "More predictable releases, clearer system health and a foundation ready to scale.", 
                year: "2022", 
                duration: "5 months", 
                images: ["https://images.unsplash.com/photo-1451187580459-43490279c0fa?auto=format&fit=crop&w=1400&q=85", "https://images.unsplash.com/photo-1558494949-ef010cbdcc31?auto=format&fit=crop&w=1400&q=85"] 
            }
    };
